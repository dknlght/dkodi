...
def test_video_exists( page_url ):
    logger.info("[video44.py] test_video_exists(page_url='%s')" % page_url)
...
def get_video_url( page_url , premium = False , user="" , password="", video_password="" ):
    logger.info("[video44.py] url="+page_url)
    # Lo pide una vez
    ...
    video_urls = []
    video_urls.append( [ scrapertools.get_filename_from_url(media_url)[-4:]+" [video44]",media_url])
